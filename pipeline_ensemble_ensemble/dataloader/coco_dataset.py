...
class coco(Dataset):
    ...
    def _image_path_from_index(self, index):
        ...
        # file_name = (str(index).zfill(3) + '.jpg')
        file_name = self.anno["images"][index]["file_name"]
    ...
    def __getitem__(self, idx):
        ...
        image_idx = a['id']
        image_name = a["file_name"]
        img_path = os.path.join(self._root_dir, self._data_name, image_name)
